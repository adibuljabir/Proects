...
int main()
{
    ...
    // journey type
    int case_;
    printf("TA-DA Tour Diary and Transport Bill Generato. Only For the purpose of Carrying Document/goods \n \nDeclare Your Journey Type:\n");
    ...
    else if (case_ == 1)
    {
        ...
        fprintf(Tour_Diary, "------------------------------------------------------------------------------------------------------------------\n");
        fprintf(Tour_Diary, "| %02d-%02d-%d | Starting On %02d-%02d-%d at %02d:%02d, I departed from %s and arrived at %s with %s on %02d-%02d-%d at %02d:%02d, total distance: %d km | While Returning On %02d-%02d-%d at %02d:%02d, I departed from %s and arrived at %s on %02d-%02d-%d at %02d:%02d, total distance: %d km |\n",
        ...
        fprintf(Tour_Diary, "---------------------------------------a--------------------------------------------------------------------------\n");

        // Writing on Transport_Bill
        fprintf(Transport_Bill, "------------------------------------------------------------------------------------------------------------------\n");
        fprintf(Transport_Bill, "| %02d-%02d-%d |Expenditure bill for porter/labor wages for loading %s in a %s from the store of %s | %.2f tk \n", day2, month2, year2, goods, vehicle, location1, expense1);
        fprintf(Transport_Bill, "| %02d-%02d-%d |Expense bill for transportation of %s from %s to %s via %s | %.2f  tk \n", day3, month3, year3, goods, location1, location2, vehicle, expense2);
        fprintf(Transport_Bill, "| %02d-%02d-%d |Expenditure bill for porter/labor wages for unloading %s from %s and carrying them to the store of %s | %.2f tk \n", day3, month3, year3, goods, vehicle, location2, expense3);
    ...
    else if (case_ == 2)
    {
        // Writing on Tour_Diary
        fprintf(Tour_Diary, "------------------------------------------------------------------------------------------------------------------\n");
        fprintf(Tour_Diary, "| %02d-%02d-%d | Starting On %02d-%02d-%d at %02d:%02d, I departed from %s, arrived at %s on %02d-%02d-%d at %02d:%02d, total distance: %d km | While Returning On %02d-%02d-%d at %02d:%02d, I departed with %s from %s and arrived at %s on %02d-%02d-%d at %02d:%02d, total distance: %d km |\n",
